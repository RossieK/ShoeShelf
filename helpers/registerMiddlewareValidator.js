...
module.exports = [
    ...
    body('fullName', 'Please add your names').isLength({ min: 2 }),
    body('password', 'The password should be at least 3 characters long and should consist only of english letters and digits').isAlphanumeric('en-US').isLength({ min: 3 }),
